...
/usr/local/bin/test_encode -A -i 2560x1440 --cvbs --enc-mode 4 --hdr-mode 0 --hdr-expo 1 --lens-warp 1 -J --btype off -K --btype off -X --bmaxsize 1080p --bsize 1080p --smaxsize 1080p -Y --bmaxsize 640x360 --bsize 640x360 -B --smaxsize 640x360
sleep 5
$MCH_HOME/bin/rtsp_server &
# /usr/local/bin/rtsp_server &
/usr/local/bin/test_encode -A -h 1080p --bitrate 1000000 --profile 2 -N15 -e -B -m 640x360 -e
fi
